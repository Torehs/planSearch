...
public class CoordinateConversion
{
  ...
  public LatLng utm2LatLon(UTM pos)
  {
	String utmStr = pos.toString();
    UTM2LatLon c = new UTM2LatLon();
    double[] latLng = c.convertUTMToLatLong(utmStr);
  ...
  private class LatLon2UTM
  {
    public String convertLatLonToUTM(double latitude, double longitude)
    {
      ...
      //    + ((int) _northing);
      UTM = String.format("%s %s %f %f", longZone, latZone,_easting,_northing);
